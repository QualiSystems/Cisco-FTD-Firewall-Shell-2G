...
### **Cisco Ftd Firewall Shell 2G**
**Cisco Ftd Firewall Shell 2G** provides you with connectivity and management capabilities such as device structure discovery and power management for the resource. 

For more information on the device, see the vendor's official product documentation.

### Standard version
**Cisco Ftd Firewall Shell 2G** is based on the Firewall Shell Standard version **3.0.2**.
...
Release: **Cisco Ftd Firewall Shell 2G**
...
#### **Cisco Ftd Firewall Shell 2G Attributes**
...
|:---|:---|
|CiscoFtdFirewallShell2G.zip|Device shell package|
|Cisco_Ftd_Firewall_Shell_2G_offline_dependencies.zip|Shell Python dependencies (for offline deployments only)|

# Importing and Configuring the Shell
This section describes how to import the **Cisco Ftd Firewall Shell 2G** shell and configure and modify the shell’s devices.
...
1. Download the *Cisco_Ftd_Firewall_Shell_2G_offline_dependencies.zip* file, see [Downloading the Shell](#downloading-the-shell).
...
**To create a resource for the device:**
  ...
  2. From the list, select **Cisco Ftd Firewall Shell 2G**.
...
For release updates, see the shell's [GitHub releases page](https://github.com/QualiSystems/CiscoFtdFirewallShell2G/releases).
...
[1]: https://github.com/QualiSystems/shellfoundry-tosca-firewall-template/blob/master/cloudshell_logo.png
[2]: https://github.com/QualiSystems/shellfoundry-tosca-firewall-template/blob/master/create_a_resource_device.png